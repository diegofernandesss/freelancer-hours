        ...
        <x-ui.modal>
            ...
            <form class="flex flex-col gap-6" wire:submit="save">
                <div>
                    ...
                    <div class="text-[16px] text-[#C3C3D1]">Faça sua oferta em horas mensais que você pode contribuir com
                        o projeto.
                    </div>
                </div>
                ...
                <div>
                    <label for="agree"
                        ...
                        <span class="text-[14px] text-[#8C8C9A]">Concordo com os Termos e Políticas de
                            privacidade.</span>
                    </label>
